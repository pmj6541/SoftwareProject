...
public final class ActivityMapBinding implements ViewBinding {
  ...
  private ActivityMapBinding(@NonNull ConstraintLayout rootView, @NonNull ImageButton backbtn,
      @NonNull Button button2, @NonNull ListView searchListView, @NonNull SearchView searchView,
      @NonNull TextView textView8, @NonNull Toolbar toolbar3) {
  ...
  public static ActivityMapBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new ActivityMapBinding((ConstraintLayout) rootView, backbtn, button2, searchListView,
